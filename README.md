...
![Alt text](https://via.placeholder.com/80.png "Можно задать title")
...
[![Alt text](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Markdown-blue-solid.svg/120px-Markdown-blue-solid.svg.png)](https://ru.wikipedia.org/wiki/Markdown)
